...
public class Application {
    ...
    // Registered with the auto-configured Jackson 3 ObjectMapper; see PGobjectSerializer.
    @org.springframework.context.annotation.Bean
    public tools.jackson.databind.JacksonModule pgObjectModule() {
        var module = new tools.jackson.databind.module.SimpleModule("pgobject");
        module.addSerializer(org.postgresql.util.PGobject.class, new PGobjectSerializer());
        return module;
    }
